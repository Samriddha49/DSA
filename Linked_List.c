...
void main()
{
    ...
    while(enter)
    {
    printf("How many nodes do you want to create in singly linked list?\n");
    int n1;
    scanf("%d",&n1);
    printf("How many nodes do you want to create in doubly linked list?\n");
    int n2;
    scanf("%d",&n2);
   ...
   //creating doubly linked list by inserting i
    ...
    printf("What element do you want to insert in singly linked list and where?\n");
    int v1,p1;
    scanf("%d %d",&v1,&p1);
    NODE* hh1=insert(h1,p1,v1);
    print(hh1);
    printf("What element do you want to insert in doubly linked list and where?\n");
    int v2,p2;
    scanf("%d %d",&v2,&p2);
